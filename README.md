...
Den LED Pin (Data) kannst du in der Datei '02_lightmanager.ino' ändern. Standardmäßig ist es GPIO 2 was z.B. bei einem Wemos D1 Mini der Pin D4 ist. Wichtig ist dass als Board 'Generic ESP8266' gewählt ist, damit die Alexa Funktion funktioniert.
